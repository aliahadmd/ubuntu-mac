...
SPEC = importlib.util.spec_from_file_location(
    "tryubuntu_build_cache", REPOSITORY / "scripts/build-cache.py"
)
...
FAKE_GUEST_BUILDER = textwrap.dedent(
    ...
    manifest = {
        "schemaVersion": 1,
        "kind": "tryubuntu-guest-artifacts",
        "artifacts": records,
    }
...
class BuildCacheTests(unittest.TestCase):
    ...
    def test_make_orders_components_and_propagates_force(self) -> None:
        ...
        self.assertEqual(3, forced.count('TRYUBUNTU_FORCE_BUILD="1"'))
    ...
    def test_runtime_file_manifest_is_the_single_validated_closure(self) -> None:
        ...
        self.assertIn("share/edk2-aarch64-code.fd", expected)
        self.assertIn("share/edk2-arm-vars.fd", expected)

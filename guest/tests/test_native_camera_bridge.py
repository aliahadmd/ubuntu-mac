...
BRIDGE_PATH = GUEST / "native-overlay/usr/local/bin/tryubuntu-native-camera-bridge"
bridge = SourceFileLoader("tryubuntu_native_camera_bridge", str(BRIDGE_PATH)).load_module()

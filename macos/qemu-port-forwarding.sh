...
#
# The launcher passes the complete value of TRYUBUNTU_QEMU_GPU_PORT_FORWARDS to
...
QEMU_PORT_FORWARDING_NETDEV='user,id=tryubuntu-net'
...
qemu_port_forwarding_configure() {
  ...
  local qpf_key=''
  local qpf_seen='|'
  local qpf_netdev='user,id=tryubuntu-net'
  local qpf_canonical=''
  local qpf_summary=''

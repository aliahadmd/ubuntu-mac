...
final class NativeClipboardBridge {
    ...
    private let stateQueue = DispatchQueue(label: "dev.tryubuntu.native.clipboard-bridge-state")
    private let writeQueue = DispatchQueue(label: "dev.tryubuntu.native.clipboard-bridge-writes")

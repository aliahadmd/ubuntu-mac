...
final class PortForwardingEditor: NSObject, NSWindowDelegate, NSTextFieldDelegate {
    ...
    private func buildWindow() {
        ...
        let explanation = NSTextField(
            wrappingLabelWithString: "Mac → Ubuntu mappings expose guest services on Mac localhost. For Ubuntu → Mac, connect to \(PortForwardPolicy.guestToHostAddress)."
        )
        ...
        addButton.setAccessibilityHelp("Adds another localhost-to-Ubuntu port mapping")
        ...
        addSSHButton.setAccessibilityHelp("Adds localhost:2222 to Ubuntu:22 over TCP")
    ...
    private func mappingRow(at index: Int) -> NSView {
        ...
        let guest = secondaryLabel("Ubuntu:")
    ...
    private func portField(value: String, index: Int, kind: FieldKind) -> NSTextField {
        ...
        field.setAccessibilityLabel(
            kind == .host
                ...
                : "Ubuntu port for mapping \(index + 1)"
        )

...
final class CoreAudioDeviceChangeMonitor {
    private let queue = DispatchQueue(label: "dev.tryubuntu.native.audio-devices")
...
final class NativeAudioBridge {
    ...
    private let stateQueue = DispatchQueue(label: "dev.tryubuntu.native.audio-bridge-state")
    private let writeQueue = DispatchQueue(label: "dev.tryubuntu.native.audio-bridge-writes")

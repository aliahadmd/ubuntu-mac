...
# The qemu bottle is not a build dependency: it supplies the prebuilt edk2
# UEFI firmware blobs that the source tarball does not carry.
readonly PINNED_QEMU_ROOT=qemu/11.1.1
...
readonly PINNED_QEMU_ARCHIVE=qemu--11.1.1.arm64_sequoia.bottle.tar.gz
...
qemu	11.1.1	$PINNED_QEMU_ARCHIVE	$PINNED_QEMU_ROOT	1fe8d43ce8ffc27303b74c9c8147226d83e1389e3093446ac91684bda8f057df
EOF
}
...
$PINNED_QEMU_ARCHIVE	$PINNED_QEMU_ROOT/share/qemu/edk2-aarch64-code.fd	share/edk2-aarch64-code.fd
$PINNED_QEMU_ARCHIVE	$PINNED_QEMU_ROOT/share/qemu/edk2-arm-vars.fd	share/edk2-arm-vars.fd
EOF
}
